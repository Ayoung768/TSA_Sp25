...
renewable_data2_filtered <- select(renewable_data2, 
...
##Look at the plot - Which one has low inflow or high inflow. Increasing or decreasing? Stable? Which one has the biggest reservior? 
