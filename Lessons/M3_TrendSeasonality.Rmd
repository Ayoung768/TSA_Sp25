...
library(lubridate) #Always install for ts models 
library(ggplot2)
library(forecast)
library(Kendall)
library(tseries)
...
#Combine t and original ino one data frame 
...
detrend_inflow<-inflow_data[,iHP+1]
ts_detrend<-ts(dtrend_inflow,start=c(1931,1))
